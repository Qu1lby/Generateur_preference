...
public abstract class Analyse {
	...
	/**
	 * Charge le fichier le décompose et instancie les ressources correspondantes
	 * @param v : Vidéothèque auquel on attachera les ressources
	...
	public static int charger(Videotheque v, String fichier) {
		try {
			...
			System.out.println("Please, report this message : ");
			e.printStackTrace();
			return -1;
		} catch(Exception e) {
			System.out.println("Please, report this message : ");
